               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<?php if ($this->session->userdata('level') == 'Admin' || $this->session->userdata('level') == 'Marketing' || $this->session->userdata('level') == 'Penjualan') : ?>
									<li class="nav-item">
								...
								<?php if ($this->session->userdata('level') == 'Admin' || $this->session->userdata('level') == 'Penjualan') : ?>
									<li class="nav-item">
